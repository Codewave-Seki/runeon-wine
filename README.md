...
- Active source candidate: `cx26.3-wine11.0-runeon.5`
...
- `cx26.3-wine11.0-runeon.5` is the active source candidate. It inherits `.4` and streamlines managed Steam launch validation. It is not available to users until the source Release and separate Runeon runtime gates are complete.
